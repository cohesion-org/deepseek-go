...
// CompletionTokensDetails represents token counts broken down by completion subtype.
...
// UnmarshalJSON supports both "reasoning_content" and "reasoning" stream fields.
