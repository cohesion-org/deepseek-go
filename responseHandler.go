...
type Choice struct {
	...
	Logprobs     any     `json:"logprobs,omitempty"` // Log probabilities of the tokens, if available. // Changed to any as of April 21 2025 because the logprobs field is sometimes a float64 and sometimes a Logprobs struct.
